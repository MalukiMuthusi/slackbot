...
- [Webhooks](https://api.slack.com/automation/triggers/webhook)

```sh
curl -X POST -H 'Content-type: application/json' --data '{"text":"Hello, World!"}' https://hooks.slack.com/services/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
```
